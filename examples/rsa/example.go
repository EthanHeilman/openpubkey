...
func main() {
	...
	clientID := "rsa-client-id-1337"
	clientSecret := "4RbHmRxl60PsOQqCc3JeZdILbXZVIAMJZ1HkRCfwiohPUZwWsng7lg1fgDFxnyedbnQPankT" // The client secret is a public value
	...
	op := providers.NewRsaOp(clientID, clientSecret, scopes, redirURIPort, callbackPath, redirectURI, signGQ)
